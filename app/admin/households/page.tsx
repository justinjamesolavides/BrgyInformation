    ...
    <div className="page-content">
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex gap-3">
              ...
              <select
                ...
                className="input-field px-4 py-3 pr-10 bg-gray-50 border-gray-200 cursor-pointer min-w-[120px]"
              >
              ...
              >
                {households.length > 0 ? (
                    ...
                    >
                      <div className="p-6">
                        <div className="flex items-start justify-between mb-4">
                          ...
                          <div className="flex gap-2">
                            ...
                            <motion.button
                              whileHover={{ scale: 1.05 }}
                              whileTap={{ scale: 0.95 }}
                              className="p-2.5 text-indigo-600 hover:bg-indigo-50 hover:text-indigo-700 rounded-lg transition-all duration-200"
                        ...
                        <div className="flex flex-wrap gap-2">
                          <span className={`px-2.5 py-1 text-xs font-semibold rounded-full ${getHouseholdTypeColor(household.householdType)}`}>
                            {household.householdType.replace('_', ' ')}
                          </span>
                          <span className={`px-2.5 py-1 text-xs font-semibold rounded-full ${getEconomicStatusColor(household.economicStatus)}`}>
                            {household.economicStatus}
                          </span>
                          <span className={`px-2.5 py-1 text-xs font-semibold rounded-full ${getStatusColor(household.status)}`}>
                            {household.status}
                          </span>
                        </div>
                      </div>
                  ...
                  >
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">No households found</h3>
      ...
      {error && !loading && (
        ...
        >
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">Error Loading Households</h3>
