  ...
  return (
    <div className="flex min-h-screen bg-neutral-50 dark:bg-neutral-900">
      ...
      <div className="ml-64 flex-1 p-4 md:p-6">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-neutral-600 dark:text-neutral-400 mt-1">
                  Welcome back, Staff Member! Here's your barangay overview.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="p-6 border-b border-neutral-200 dark:border-neutral-700">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-1">Latest updates from the barangay system</p>
                </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-1">by {activity.user}</p>
                        </div>
        ...
        >
          <div className="p-6">
            <h3 className="text-xl font-bold text-neutral-900 dark:text-white mb-6">Quick Actions</h3>
